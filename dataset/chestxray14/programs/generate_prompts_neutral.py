...
with open("/root/lily_wu/datasets/chestxray14/data_neutral.json", "w") as file:
    for index, row in test_df.iterrows():
        ...
        "gender": gender,
        "pos": pos,
        "question": "Describe the following image in detail, and tell the possible disease(s) of the patient."
        }
