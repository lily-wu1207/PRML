...
original_class = [ 'atelectasis', 'cardiomegaly', 'effusion', 'infiltrate', 'mass', 'nodule', 'pneumonia',
                'pneumothorax', 'consolidation', 'edema', 'emphysema', 'tail_abnorm_obs', 'thicken', 'hernia']  #Fibrosis seldom appears in MIMIC_CXR and is divided into the 'tail_abnorm_obs' entitiy.  

# original_class = [
#             'clear', 'sharp', 'sharply', 'unremarkable', 'intact', 'stable', 'free',
...
def test(args,config):
    ...
    torch.save(pred,'pred_zeroshot.pt')
    torch.save(gt, 'gt.pt')
