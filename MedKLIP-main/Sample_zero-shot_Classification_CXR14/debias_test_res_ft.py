...
def test(target_class):
    ...
    disease_book = [json_book[i] + "It is is mostly seen in elderly patients.It is is mostly seen in elderly patients." for i in json_book]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='/root/lily_wu/MedKLIP-main/Sample_zero-shot_Classification_CXR14/my_results/zero-shot-biased')
