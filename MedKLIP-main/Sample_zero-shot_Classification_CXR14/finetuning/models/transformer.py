...
class TransformerDecoder(nn.Module):
    ...
    def __init__(self, decoder_layer, num_layers, norm=None, return_intermediate=False):
        ...
        # self.adapter_linear1 = nn.Linear(256, 96)
        # self.adapter_dropout = nn.Dropout(0.3)
        # self.adapter_linear2 = nn.Linear(96, 256)
    ...
    def forward(self, tgt, memory,
        ...
        for n,layer in enumerate(self.layers):
            ...
            # output = self.adapter_linear1(output)
            # output = self.adapter_dropout(output)
            # output = self.adapter_linear2(output)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
        ...
        self.adapter_linear1 = nn.Linear(d_model, 96)
        self.adapter_dropout = nn.Dropout(0.3)
        self.adapter_linear2 = nn.Linear(96, d_model)
    ...
    def forward_post(self, tgt, memory,
        ...
        tgt = self.norm2(tgt)
        tgt2 = self.linear2(self.dropout(self.activation(self.linear1(tgt)))) # FF
        tgt = tgt + self.dropout3(tgt2)
        tgt = self.norm3(tgt) # Add&Norm
        tgt3 = self.adapter_linear2(self.adapter_dropout(self.activation(self.adapter_linear1(tgt)))) # adapter
